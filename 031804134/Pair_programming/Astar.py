        ...
        for i in range(0,9):
            ...
            for j in range(i+1,9):
                ...
                if retCode != 0:
                    ...
                    print('自由交换第(%s)和第(%s)块(原本的位置，它们现在的位置是第（%d）和（%d）)'%(list_srcLayout[i],list_srcLayout[j],i,j))
...
if __name__ == "__main__":
	#测试数据
    srcLayout  = "421860753"#输入接口
    # print('srcLayout',srcLayout)
    destLayout = "512340678"
    s = Astarmain(srcLayout, destLayout)
    # print(srcLayout)
    # print(destLayout)
    print(s)